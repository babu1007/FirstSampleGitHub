...
@BeforeSuite
@Parameters({"browser","browserVersion","OperatingSystemName","OperatingSystemVersion","runningPlatform","TestDatapropertyFileName","WorkspacePath","AntParameter","pickBrowserBasedOnDay","UseNewBrowserForEachTest"})
	public static void initWebDriver(String browser,String browserVersion,String os,String osVersion,String runLocation,String TestDatapropertyFileName, String WorkspacePath,String AntParameter,String pickBrowserBasedOnDay,String UseNewBrowserForEachTest){
	...
	System.out.println(pickBrowserBasedOnDay);
	...
	FrameworkUtil.dictPropertyData.put("NAV.LIBRARY.LOCATION", "C:/Automation Testing/Selenium/SeleniumAutomationTesting/Libraries/");
	...
	try {
		...
		if (UseNewBrowserForEachTest.equalsIgnoreCase("true") )
		FrameworkUtil.bUseNewBrowserForEachTest=true;
		...
		FrameworkUtil.sResultPath = "C:/Automation Testing/Selenium/SeleniumAutomationTesting/Selenium Results/";
        if (AntParameter.contains("debug")){
            FrameworkUtil.sResultPath = "C:/Automation Testing/Selenium/SeleniumAutomationTesting/Selenium Results/debug/";
      }
...
public static void openPortal(){
	String sURL;
	try {
		FrameworkUtil.sTestCaseName = "openPortal";
		FrameworkUtil.sManualTestCaseName = "Open Portal";
		...
		FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), "Browser", "Browser details", "Done", WebDriverUtil.getBrowserVersion());
		FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), "Platform", "Platform details", "Done", WebDriverUtil.getPlatform());
		FrameworkUtil.sTestStepStartTime = FrameworkUtil.getCurrentTimeStamp();
		//sURL = (String)FrameworkUtil.dictPropertyData.get("NAV.QA.URL");
		sURL = (String)FrameworkUtil.dictPropertyData.get("NAV.PPR.URL");
		WebDriverUtil.getDriver().get(sURL);
		//WebDriverUtil.getSeleniumDriver(sURL);
		String sNavTitle = WebDriverUtil.getDriver().getTitle();
		String sCurrentURL = WebDriverUtil.getDriver().getCurrentUrl();
		...
		FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), "Navigator Application", "Open Navigator", "Done", "Navigator opened with URL: "+ sCurrentURL );
		FrameworkUtil.writefile("</table>", FrameworkUtil.sResultPath, FrameworkUtil.sCustomFileName);
...
public static void selectBrowserBasedonDay(String sBrowser){
	...
	WebDriverUtil.browserVersion  = "latest";
	WebDriverUtil.os = "windows";
	WebDriverUtil.osVersion = "10";
	}
	try {
		Date now = new Date();
		SimpleDateFormat simpleDateformat = new SimpleDateFormat("E"); // the day of the week abbreviated
		...
		System.out.println("Day of today is : " + sDay + ", Browser selected : " + WebDriverUtil.browser);
	} catch (Exception e) {
