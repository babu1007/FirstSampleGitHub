...
public class DraasPageFactory {
	...
	//DraaS Section
	@FindBy(how=How.XPATH,using="//section[@class='navigation']//a[text()='DRaaS']")
	//@FindBy(how=How.ID, using="draasLink")
	private WebElement nav_DraaSLink;
	...
	//Draas Link on Home Page
	@FindBy(how=How.XPATH, using="//a[@id='draasLink']")
	private WebElement nav_DraasLinkHome;
	...
	//@FindBy(how=How.ID,using="button-1028-btnInnerEl")
	...
	// Taken from DRaaS PageFactory --> Split workspace   -- QAA04
	...
	//OOS TC
		@FindBy(how=How.LINK_TEXT,using="TierPoint Support")
		private WebElement nav_DraasTierPointSupport;
...
///////***********************Keffer TestCase Elements ***********************************///////
  ...
  private WebElement nav_DraasC2CRProductPopUpBox;
	...
	public WebElement getNav_DraasLinkHome(){
    	 FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
         return nav_DraasLinkHome; 
     }
	...
	public WebElement getNav_DraasTierPointSupport() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_DraasTierPointSupport;
	}
