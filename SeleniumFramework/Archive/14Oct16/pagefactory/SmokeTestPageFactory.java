...
//taken from SmokePageFactory - split workspace 
	//private EVDC
	...
	@FindBy(how=How.XPATH, using="//h1[@class='user-greeting']")
	...
	@FindBy(how=How.XPATH, using="//a[contains(@id,'tab-')]//span[text()='Host']")
