...
////////////////////////////////////////Physical DC Related Objects - QAA03////////////////////////////////
	
@FindBy(how=How.ID, using="PDC_maindiv")
private WebElement nav_PhysicalDCPortlet;

@FindBy(how=How.XPATH, using="//div[@id='PDC_maindiv']//div[contains(@class,'-committed-text')]")
private WebElement nav_PhysicalDC_CommittedData;

@FindBy(how=How.XPATH, using="//div[@id='PDC_maindiv']//div[contains(@class,'-allocated-text')]")
private WebElement nav_PhysicalDC_AllocatedData;

@FindBy(how=How.XPATH, using="//div[@id='PDC_maindiv']//div[contains(@class,'pdc_header_cls')]")
private WebElement nav_PhysicaServicesPortlet;
	...
	public WebElement getNav_PhysicalDCPortlet() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_PhysicalDCPortlet;
	}

	public WebElement getNav_PhysicalDC_CommittedData() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_PhysicalDC_CommittedData;
	}

	public WebElement getNav_PhysicalDC_AllocatedData() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_PhysicalDC_AllocatedData;
	}

	public WebElement getNav_PhysicaServicesPortlet() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_PhysicaServicesPortlet;
	}
