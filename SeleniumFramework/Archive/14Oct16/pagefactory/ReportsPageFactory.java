...
public class ReportsPageFactory {
	...
	//@FindBy(how=How.XPATH, using="//div[@id='storage-chart']//*[name()='svg']//*[name()='rect'][@class=' highcharts-background']")
	@FindBy(how=How.XPATH, using="//div[@id='storage-chart']//*[name()='svg']")
	...
	////Added by QAA03 on 08/03/2016
			@FindBy(how=How.ID, using="ReportLauncherPortletDiv")
			private WebElement nav_ReportsDivision;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public WebElement getNav_ReportsDivision() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_ReportsDivision;
	}
