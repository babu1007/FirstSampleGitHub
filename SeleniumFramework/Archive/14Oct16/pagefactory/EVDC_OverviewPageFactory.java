...
//		@FindBy(how=How.XPATH,using="//h2[contains(text(),'Storage')]")
	...
	//Commented and updated by priyanka as text() not to be used
	//@FindBy(how=How.XPATH,using="//h2/a[Contains(@href,'storage-profiles?StorageProfiles=true&currEvdc')]")
	...
	@FindBy(how=How.XPATH, using="//div[@id='nav_org_maindev']//section[contains(@style,'border-bottom:')]//section[@class='evdc_info']/div[2]/dl/dd")
	private WebElement nav_PrivateEVDC_NetworkCount;
	...
	//Commented as there is change in xpath for Add VIP link and added below xpath By Sukur Babu.- Dated on 15-02-2016
	//@FindBy(how=How.XPATH, using="//div[@id='vips-create']/span/a")
	@FindBy(how=How.XPATH, using="//div[@id='vips-page']/div[@class='lb-header']/span/a")
	...
	@FindBy(how=How.ID, using="htmleditor-1030-inputCmp-iframeEl")
	...
	@FindBy(how=How.XPATH, using=".//*[@id='button-1060-btnInnerEl']")
...
/////******************Keffer Pagefactory Elements QAA03*********************////
		...
		@FindBy(how=How.XPATH, using="//div[@id='idEVDCRollup']//img[@src='/navorganization-portlet/resources/images/Add_Dummy_rollup.PNG']")
		private WebElement nav_EVDCImageAfterRollOn;
	...
	public WebElement getNav_EVDCImageAfterRollOn() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_EVDCImageAfterRollOn;
	}

	public WebElement getNav_PrivateEVDC_NetworkCount() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_PrivateEVDC_NetworkCount;
	}
