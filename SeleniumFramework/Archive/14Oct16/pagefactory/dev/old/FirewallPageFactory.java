...
public class FirewallPageFactory {
	...
	// GOM -> Network objects 	
			...
			@FindBy(how=How.XPATH, using="(//div[@id='gom_svc_tree_panel']//span[@class='x-column-header-text-wrapper'])[2]")
			private WebElement nav_ServiceObjects_Protocol_ColumnHeader;
			
			@FindBy(how=How.XPATH, using="(//div[@id='gom_svc_tree_panel']//span[@class='x-column-header-text-wrapper'])[3]")
			private WebElement nav_ServiceObjects_ServiceEnd_ColumnHeader;
			
			@FindBy(how=How.XPATH, using="(//div[@id='gom_svc_tree_panel']//span[@class='x-column-header-text-wrapper'])[4]")
			private WebElement nav_ServiceObjects_Port_ColumnHeader;
			
			@FindBy(how=How.XPATH, using="(//div[@id='gom_svc_tree_panel']//span[@class='x-column-header-text-wrapper'])[5]")
			private WebElement nav_ServiceObjects_Discription_ColumnHeader;
			
			
			
		// Vivek -	// service objects
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			public WebElement getNav_ServiceObjects_Protocol_ColumnHeader() {
				FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
				return nav_ServiceObjects_Protocol_ColumnHeader;
			}

			public WebElement getNav_ServiceObjects_ServiceEnd_ColumnHeader() {
				FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
				return nav_ServiceObjects_ServiceEnd_ColumnHeader;
			}

			public WebElement getNav_ServiceObjects_Port_ColumnHeader() {
				FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
				return nav_ServiceObjects_Port_ColumnHeader;
			}

			public WebElement getNav_ServiceObjects_Discription_ColumnHeader() {
				FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
				return nav_ServiceObjects_Discription_ColumnHeader;
			}
