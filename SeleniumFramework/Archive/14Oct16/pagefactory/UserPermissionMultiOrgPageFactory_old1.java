...
public class UserPermissionMultiOrgPageFactory_old1 {
...
////#########################################################Vivek start############################################
	...
	@FindBy(how=How.XPATH,using="//div[@class='marketing_table']")
	...
	@FindBy(how=How.XPATH,using="//div[@class='marketing_table_av']")
	...
	@FindBy(how=How.XPATH,using="//div[@class='marketing_table_ddos']")
