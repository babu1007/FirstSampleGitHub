...
public class LoadBalancerPageFactory {
	...
	//@FindBy(how=How.XPATH, using="//div[@id='vips-print']//img[@alt='PDF']")
	//Commented the above xpath and added the below one - Vivek - 02232016
	@FindBy(how=How.XPATH,using="//div[@id='vips-page']//div[@class='tabPrint']//img[contains(@src,'PDF_Icon')]")
	private WebElement navVirtualIpTab_PDFIcon;
	
	//@FindBy(how=How.XPATH, using="//div[@id='vips-print']//img[@alt='CSV']")
	//Commented the above xpath and added the below one - Vivek - 02232016
	@FindBy(how=How.XPATH,using="//div[@id='vips-page']//div[@class='tabPrint']//img[contains(@src,'CSV_Icon')]")
	private WebElement navVirtualIpTab_CSVIcon;
	
	//@FindBy(how=How.XPATH, using="//div[@id='vips-create']//a")
	//Commented the above xpath and added the below one - Vivek - 02232016
	//@FindBy(how=How.XPATH,using="//*[@id='vips-page']//a[contains(@onclick,'addVirtualIP')]")
	@FindBy(how=How.XPATH,using="//span[@id='vips-create']/a")
...
/// common objects for all add pop up box elements 	
	...
	@FindBy(how=How.XPATH,using="//a[contains(@class,'CreateTicketPopupOK')]")
	private WebElement navPopUp_OkBtn;
	
	@FindBy(how=How.ID,using="button-1005")
	private WebElement navPopUp_OKConfirmBtn;
...
/// POOls Tab
	// this below element is updated by NMR - 09/20/2016
	@FindBy(how=How.XPATH, using="//li[@id='poolsTab']/a")
	//@FindBy(how=How.ID, using="poolsTab")
	private WebElement navPoolsTab;
	
	//Commented the below xpath as it got changed - Vivek - 02232016
	//@FindBy(how=How.XPATH, using="//div[@id='ldblncr-pool_header']//img[@alt='PDF']")
	@FindBy(how=How.XPATH,using="//div[@id='ldblncr-pool-page']/div[@class='lb-header']/div[@class='tabPrint']//img[@alt='PDF']")
	private WebElement navPoolsTab_PDFIcon;
	
	//Commented the below xpath as it got changed - Vivek - 02232016
	//@FindBy(how=How.XPATH, using="//div[@id='ldblncr-pool_header']//img[@alt='CSV']")
	@FindBy(how=How.XPATH,using="//div[@id='ldblncr-pool-page']/div[@class='lb-header']/div[@class='tabPrint']//img[@alt='CSV']")
	private WebElement navPoolsTab_CSVIcon;
	
	//Commented the below xpath as it got changed- Vivek - 02232016
	//@FindBy(how=How.XPATH, using="//div[@id='ldblncr-pool_create']//a")
	//@FindBy(how=How.XPATH,using="//div[@id='ldblncr-pool-page']/div[@class='lb-header']//a[text()='Add a Load Balancer']")
	@FindBy(how=How.XPATH,using="//span[@id='pools_create']/a")
	...
	@FindBy(how=How.LINK_TEXT,using="Add a Pool")
	private WebElement navPools_AddLB;
	
	// this elements is added by QAA04 - 09/16/2016
    @FindBy(how=How.XPATH, using="//div[contains(@id,'DBServers-body')]")
	private WebElement nav_Pool_Expand_MemberWebTableParent;
   
/// Instances Tab
	@FindBy(how=How.ID, using="instanceTab")
	private WebElement navInstanceTab;
	
	//@FindBy(how=How.XPATH, using="//div[@id='ldblncr-instance-print']//img[@alt='PDF']")
	//Commented the above xpath and added the below one - Vivek - 02232016
	@FindBy(how=How.XPATH,using="//div[@id='ldblncr-instance-page']//div[@class='tabPrint']//img[contains(@src,'PDF_Icon')]")
	private WebElement navInstanceTab_PDFIcon;
	
	//@FindBy(how=How.XPATH, using="//div[@id='ldblncr-instance-print']//img[@alt='CSV']")
	//Commented the above xpath and added the below one - Vivek - 02232016
	@FindBy(how=How.XPATH,using="//div[@id='ldblncr-instance-page']//div[@class='tabPrint']//img[contains(@src,'CSV_Icon')]")
    private WebElement navInstanceTab_CSVIcon;
	
	//Commented the below xpath as it got changed - Vivek - 02232016
	//@FindBy(how=How.XPATH, using="//div[@id='ldblncr-instance_create']//a[text()='Add a Load Balancer']")
	...
	@FindBy(how=How.NAME,using="vipName")
	private WebElement nav_VirtualIP_AddVIP_VIPNameTextBox;
	
	@FindBy(how=How.ID,using="vip-edgatewayID-trigger-picker")
	private WebElement nav_VirtualIp_AddVIP_EdgeGatewayDropdown;
	
	@FindBy(how=How.ID,using="poolID-trigger-picker")
	private WebElement nav_VirtualIp_AddVIP_PoolDropdown;
	...
	// these below elements added by NMR - 08/17/2016
	@FindBy(how=How.XPATH, using="//input[@name='poolName']")
	private WebElement nav_AddPool_PoolName;
	
	@FindBy(how=How.XPATH, using="//div[contains(@id,'combobox')][contains(@id,'-trigger-picker')]")
	private WebElement nav_AddPool_HealthMonitorDropDownArrow;
	
	@FindBy(how=How.XPATH, using="//input[@name='healthMonitor']")
	private WebElement nav_AddPool_HealthMonitorEditField;
	
	@FindBy(how=How.ID, using="balancingMethod-trigger-picker")
	private WebElement nav_AddPool_BalancingMethodDropDownArrow;
	
	@FindBy(how=How.ID, using="balancingMethod-inputEl")
	private WebElement nav_AddPool_BalancingMethodEditField;
	
	@FindBy(how=How.ID, using="addmemlink_p")
	private WebElement nav_AddPool_AddMemberLink;
	
	@FindBy(how=How.ID, using="advPoolreset-btnInnerEl")
	private WebElement nav_AddPool_ResetBtn;
	/*
	@FindBy(how=How.ID, using="advPoolsubmit-btnInnerEl")
	private WebElement nav_AddPool_SubmitBtn;*/
	
	/*@FindBy(how=How.XPATH, using="//div[@id='fc-targetEl']//div[contains(@id,'-trigger-picker')]")
	private WebElement nav_AddPool_AddMemberDropDownArrow;
	
	*/
	@FindBy(how=How.ID, using="advPoolsubmit")
	private WebElement nav_AddPool_SubmitBtn;
...
////////////////////////////////////////////////////////////////////////////////
	...
	public WebElement getNavPopUp_OKConfirmBtn() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return navPopUp_OKConfirmBtn;
	}

	public WebElement getNav_VirtualIP_AddVIP_VIPNameTextBox() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_VirtualIP_AddVIP_VIPNameTextBox;
	}

	public WebElement getNav_VirtualIp_AddVIP_EdgeGatewayDropdown() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_VirtualIp_AddVIP_EdgeGatewayDropdown;
	}

	public WebElement getNav_VirtualIp_AddVIP_PoolDropdown() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_VirtualIp_AddVIP_PoolDropdown;
	}
	...
	public WebElement getNav_AddPool_PoolName() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_PoolName;
	}

	public WebElement getNav_AddPool_HealthMonitorDropDownArrow() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_HealthMonitorDropDownArrow;
	}

	public WebElement getNav_AddPool_BalancingMethodDropDownArrow() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_BalancingMethodDropDownArrow;
	}

	public WebElement getNav_AddPool_AddMemberLink() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_AddMemberLink;
	}

	public WebElement getNav_AddPool_ResetBtn() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_ResetBtn;
	}

	public WebElement getNav_AddPool_SubmitBtn() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_SubmitBtn;
	}

	public WebElement getNav_AddPool_HealthMonitorEditField() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_HealthMonitorEditField;
	}

	public WebElement getNav_AddPool_BalancingMethodEditField() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddPool_BalancingMethodEditField;
	}

	public WebElement getNav_Pool_Expand_MemberWebTableParent() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_Pool_Expand_MemberWebTableParent;
	}
