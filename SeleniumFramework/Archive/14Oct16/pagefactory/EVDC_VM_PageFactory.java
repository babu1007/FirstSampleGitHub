...
public class EVDC_VM_PageFactory {
	...
	@FindBy(how=How.XPATH,using="//*[@id='headercontainer-1010-innerCt']")
	private WebElement nav_VMTabList;
	
	// Taken From VMPageFactory -> Split work space -- QAA04
	//@FindBy(how=How.XPATH, using="//span[text()='OK']")
	//updated by Arul on 06/24/16
	@FindBy(how=How.XPATH,using="//div[@id='est_ticket_form_cmp']//a[contains(@id,'button-')]//span[text()='Submit']")
	...
	//updated by Arul on 06/24/16
	@FindBy(how=How.XPATH, using="//div[@id='est_ticket_form_cmp']//input[contains(@id,'textfield-')]")
	private WebElement nav_TitleAddStorageTierPopUp;
	
	// this element is updated by NMR - 06/21/2016
	@FindBy(how=How.XPATH, using="//div[@id='est_ticket_form_cmp-outerCt']//div[contains(@id,'-trigger-picker')]")
	...
	*/
	...
	//Reset popup message
	@FindBy(how=How.XPATH,using="//div[class='x-mask-msg']")
	private WebElement nav_MaskVMPage;

	//###########################
		//Virtual Machine Console
	//###########################
	//Updated by QAA03 on 06/17/2016
	//@FindBy(how=How.XPATH,using="//object[@id='vmrc']")
	//@FindBy(how=How.XPATH,using="//object")
	@FindBy(how=How.ID,using="wmksContainer")
	...
	//Console Full Screen image
	@FindBy(how=How.XPATH,using="//span[contains(@style,'full-screen')]")
	private WebElement nav_ConsoleFullScreenImage;
	
	//@FindBy(how=How.ID,using="vm_button_ctrlaltdel")
	@FindBy(how=How.ID,using="ext-quicktips-tip-innerCt")
	...
	//	@FindBy(how=How.XPATH,using=".//*[contains(text(),'Windstream Objects')]")
		...
		//Close button for AddVM popup
		@FindBy(how=How.XPATH,using="//div[@id='closeWindowButtonDivAddBlankC']/button[@class='close_icon']")
		private WebElement nav_AddVMTemplatePopupCloseIcon;
		
		//Cancel button for AddVM Templatepopup 
		@FindBy(how=How.ID,using="cancelVMAdd")
		private WebElement nav_AddVMTemplatePopUpCancelBtn;
		...
		//New POPup
		@FindBy(how=How.XPATH,using="//div[text()='No VM Edit changes are recognized']")
		private WebElement nav_NoVMEditPopUpMsg;
		
		@FindBy(how=How.ID,using="closeWindowButtonEl")
		private WebElement nav_CloseWindowButton;
		
		
	//###############################New FeedBack Message#################################
	@FindBy(how=How.ID,using="vmUpdatetext")
	private WebElement nav_NewFeedBackMsg;
	
	//Feedback Notification popup 
	@FindBy(how=How.XPATH,using="//div[@id='idVmUpdatesBox']//table[@class='datatable']")
	private WebElement nav_NewFeedBackNotificationTablePopup;
	
	//FeedBack notification popup - close btn
	@FindBy(how=How.ID,using="idVMUpdatesWindowCloseBtn")
	private WebElement nav_NotificationPopupCloseBtn;
	...
	public WebElement getNav_NoVMEditPopUpMsg() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_NoVMEditPopUpMsg;
	}

	public WebElement getNav_CloseWindowButton() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_CloseWindowButton;
	}

	public WebElement getNav_MaskVMPage() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_MaskVMPage;
	}

	public WebElement getNav_AddVMTemplatePopupCloseIcon() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddVMTemplatePopupCloseIcon;
	}

	public WebElement getNav_AddVMTemplatePopUpCancelBtn() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_AddVMTemplatePopUpCancelBtn;
	}

	public WebElement getNav_NewFeedBackMsg() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_NewFeedBackMsg;
	}

	public WebElement getNav_NewFeedBackNotificationTablePopup() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_NewFeedBackNotificationTablePopup;
	}

	public WebElement getNav_NotificationPopupCloseBtn() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_NotificationPopupCloseBtn;
	}

	public WebElement getNav_ConsoleFullScreenImage() {
		FrameworkUtil.sElementName = Thread.currentThread().getStackTrace()[1].getMethodName();
		return nav_ConsoleFullScreenImage;
	}
