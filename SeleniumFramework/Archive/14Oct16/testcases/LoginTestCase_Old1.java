...
public class LoginTestCase_Old1 {
...
Manual TestCase	: 
Description		: login to navigator as kirkj user
Author 			: Sukur Babu. B
Creation Date 	: 1/05/2015
release Name    : Hague
Pre-Requisites	:
...
release Name    : Lefcourt
Pre-Requisites	:
Revision History: updated the org name by QAA03
...
public static boolean nav_TierPointLogin(String sUserName,String sPassword)
{
	String sURL=null,sSummaryURL;
	WebDriver driver1 = WebDriverUtil.getDriver();
	PageFactory.initElements(driver1, login);
	//PageFactory.initElements(driver, Home);
