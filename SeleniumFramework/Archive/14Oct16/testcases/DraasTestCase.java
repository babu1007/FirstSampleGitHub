...
//**********************These TestScripts are taken From Clark-Start*********************************************//
	/*==============================================================
	TestScript 		: verifyPDFandCSVlinks
	...
	==============================================================*/
	@Test(priority=101)
	public void verifyPDFandCSVlinks() {
		...
		boolean verifyPDF,verifyCSV;
		 ...
		 try{
		  ...
		  FrameworkUtil.sTestCaseName="Clark-verifyPDFandCSVlinks";
	...
	WebDriver driver = WebDriverUtil.getDriver();
		...
		//LoginTestCase.nav_Login(sUserName, sPassword);
		LoginTestCase_Old1.LoginAsARoleEUser();
		WebObjectUtil.explicitWait(5);
		//Navigating to Draas Page
		navigateToDraaS(sUserName);
	...
	public void navVerifyAddDriveSBRPDFCSV()
	{
		...
		//LoginTestCase.nav_Login(sUserName, sPassword);
		LoginTestCase_Old1.LoginAsSingUser1User();
	...
	public void navVerifyDRaas()
	{
		...
		FrameworkUtil.updateCustomResultBasedOnStatus(sText.equals("DRaaS"),"Verify DRaaS text :"+sText);
	...
	public void navVerifyLearnMore()
	{
		...
		//LoginTestCase.nav_Login(sUserName, sPassword);
		//LoginTestCase.LoginAsRRamDevUser();
		LoginTestCase_Old1.LoginAsQaautoUser();
		//Click and verifying DraaS Landing page
		navigateToDraaS(sUserName);
	...
	public void navVerifyAbleCollapseTwistys()
	{
		...
		sPassword = (String) FrameworkUtil.dictPropertyData.get("NAV.TSTDEVCO1.RRAMDEV.PASSWORD");
		//LoginTestCase.nav_Login(sUserName, sPassword);
		LoginTestCase_Old1.LoginAsRRamDevUser();
...
try{
		...
		//LoginTestCase.nav_Login(sUserName,sPassword);
		LoginTestCase_Old1.LoginAsRoleAUser();
		WebObjectUtil.clickElement(Draas.getNav_DraasLinkHome());
	...
	public void navVerifyUserCanAccessLearnMore()
	{
		...
		FrameworkUtil.sTestCaseName = "Clark-navVerifyUserCanAccessLearnMore";
 ...
 @Test(priority=109)
	...
	public static void navigateToDraaS(String sUserName)
	{
		...
		boolean bStatus;
		//Below commented and updated by QAA03 on 07/25/2016
		//Added by arul on 02/29/2016
		//Click and verifying DraaS Landing page
		
	/*	WebObjectUtil.ClickAndMouseHover(Home.getNav_SupportTab());
		WebObjectUtil.clickElement(Home.getNav_DRaaSMenuLink());*/
		//WebObjectUtil.clickElement(Draas.getNav_DraasLinkHome());
		WebObjectUtil.clickElement(Home.getNav_SupportTab());
		WebObjectUtil.clickElement(Home.getNav_DRaaSMenuLink());
		WebObjectUtil.explicitWait(10);
		bStatus=WebObjectUtil.verifyElementPresent(Draas.getNav_breadCrumbChain());
		...
		FrameworkUtil.updateCustomResultBasedOnStatus(bStatus,"User able to view Draas Page");
	}
...
////__________________________ Keffer TestCases start ________________________ ////
...
==============================================================*/
	...
	/*==============================================================
	Method Name 	: createTicketinDRaaS
	Description		: This will create ticket
	Author 			: Vivek Kumar
	Creation Date 	: 06/01/2016
	Pre-Requisites	: 
	Revision History:
	==============================================================*/
	public static void createTicketinDRaaS()
	{
		...
		String sIPAddress,sDriveName,sHostOS,sVersion,sRecoveryDest;
...
////__________________________ Keffer TestCases end ________________________ ////
	
//// _________________________ out of scope test cases __________________________________________________ ///

	/*==============================================================
	TestScript  	: navCreateNVerifyTicketUsingAddDrive
	Manual TestCase	: QAT-1465-WCP_3415_TC_1.5_Ticket watchers_DRaaS_Add Drive ticket.
	Description		: verify user is able to click "Add Drive" link and perform the action and verify the same in Ticket Page too.
	Author 			: Vivek Kumar
	Creation Date 	: 06/01/2016
	Pre-Requisites	:
	Revision History:
	==============================================================*/
	@Test(priority=3)
	public void navCreateNVerifyTicketUsingAddDrive()
	{
		WebDriver driver = WebDriverUtil.getDriver();
		PageFactory.initElements(driver, Draas);
		PageFactory.initElements(driver, Common);
		
		String sUserName,sPassword,sFeedBackMsg,sTicketID;
		boolean bStatus;
		
		
		FrameworkUtil.sTestCaseName = "navCreateNVerifyTicketUsingAddDrive";
		FrameworkUtil.sManualTestCaseName="QAT-1465-WCP_3415_TC_1.5_Ticket watchers_DRaaS_Add Drive ticket.";
		FrameworkUtil.updateTestCaseNameinResult(FrameworkUtil.sTestCaseName,FrameworkUtil.sManualTestCaseName);
		...
		//Navigating to Draas Page
		DraasTestCase.navigateToDraaS(sUserName);
		
		//Clicking on Add Drive Link		
		WebObjectUtil.clickElement(Draas.getNav_SCRAddDrive());
		
		//Creating Ticket
		DraasTestCase.createTicketinDRaaS();
		
		sFeedBackMsg=Draas.getNav_FeedBack().getText().trim();
		String[] arrFeedBackMsg=sFeedBackMsg.split(":");
		sTicketID=arrFeedBackMsg[1].trim();
		
		//Navigate to Ticket Page
		TicketTestCase.navigateToTicketPage();
		//Searching the recent created Ticket with Ticket Id
        TicketTestCase.searchTicket("Ticket ID",sTicketID);
        
        WebObjectUtil.explicitWait(5);
        //Validating the Ticket found with created ticket created
	...
	/*==============================================================
	TestScript  	: verifyDRaaSDelTicket
	Manual TestCase	: QAT-1466-WCP_3415_TC_1.6_Ticket watchers_DRaaS_Remove Drive ticket
	Description		: Verify the ticket generate after deleting under DRaas is there under Ticket page
	Author 			: Vivek Kumar
	Creation Date 	: 06/01/2016
	Pre-Requisites	:
	Revision History:
	==============================================================*/
	@Test(priority=4)
	public void verifyDRaaSDelTicket()
	{
		WebDriver driver = WebDriverUtil.getDriver();
		PageFactory.initElements(driver, Draas);
		PageFactory.initElements(driver, Common);
		...
		FrameworkUtil.sTestCaseName = "verifyDRaaSDelTicket";
		FrameworkUtil.sManualTestCaseName="QAT-1466-WCP_3415_TC_1.6_Ticket watchers_DRaaS_Remove Drive ticket";
		FrameworkUtil.updateTestCaseNameinResult(FrameworkUtil.sTestCaseName,FrameworkUtil.sManualTestCaseName);
		...
		DraasTestCase.navigateToDraaS(sUserName);
		//clicking on Manage btn and verifying the delete functionality
		DraasTestCase.VerifyDeleteFunctionality();
	...
	/*==============================================================
	TestScript  	: verifyDraasSupportTicket
	Manual TestCase	: QAT-1463-WCP_3415_TC_1.4_Ticket watchers_DRaaS_Support Ticket
	Description		: Verify when a ticket is created from DRaaS page (DRaaS support ticket)it should be in Ticket page too
	Author 			: Vivek Kumar
	...
	==============================================================*/
	@Test(priority=5)
	public void verifyDraasSupportTicket()
	{
		WebDriver driver = WebDriverUtil.getDriver();
		PageFactory.initElements(driver, Draas);
		PageFactory.initElements(driver, Common);
		...
		FrameworkUtil.sTestCaseName = "verifyDraasSupportTicket";
		FrameworkUtil.sManualTestCaseName=" QAT-1463-WCP_3415_TC_1.4_Ticket watchers_DRaaS_Support Ticket";
		FrameworkUtil.updateTestCaseNameinResult(FrameworkUtil.sTestCaseName,FrameworkUtil.sManualTestCaseName);
		...
		//Clicking on TierPoint support link
		WebObjectUtil.clickElement(Draas.getNav_DraasTierPointSupport());
		WebObjectUtil.explicitWait(5);
		
		/*//Inputting TP support text field
		WebObjectUtil.SetValueEdit(Draas.getNav_DraasTPSupportTitle(), "SeleniumTest");
		Draas.getNav_DraasTPSupportBody().sendKeys("SeleniumTest Body");
		//WebObjectUtil.SetValueEdit(Draas.getNav_DraasTPSupportBody(), );
		WebObjectUtil.clickElement(Draas.getNav_DraasTPSupportOKBtn());
		*/
		NavigatorCommonMethods.submitDialogForCreateTicket("DRaaS");
		LoginTestCase_Old1.nav_Logout();
