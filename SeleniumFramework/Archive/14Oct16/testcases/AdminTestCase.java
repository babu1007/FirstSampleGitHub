...
//___________________________ Gideon TestCases ________________________________________///
	...
	==============================================================*/
		...
		try {
			  ...
			  //oginTestCase.nav_Login(sUserName, sPassword);
			  LoginTestCase_Old1.LoginAsIshannonUser();
...
////// _____________________________ Hague Test cases ________________________________________________ ///////////
	...
	==============================================================*/
		...
		public void verifyImpersonationinEVDCSelector()
		{
			...
			try {
			    ...
			    //Clicking on org link with respect to selected organization in Organization Table
				//navAdminClickActionsButtonOrg(sOrgToselect);
				navAdminClickOrgLink(sOrgToselect);
	...
	/////________________________________ Keffer test cases start _____________________________________ ///////////////
	...
	==============================================================*/
		...
		public void verifyChangeChildEntityForInvalidParent()
		{
			...
			try {
				FrameworkUtil.sTestCaseName = "verifyChangeChildEntityForInvalidParent";
	...
	/////________________________________ Keffer test cases end _____________________________________ ///////////////
		...
		public static void navigatingToControlPanelOrgPage()
		{
	     ...
	     try {   	
	    	    ...
	    	    // WebObjectUtil.clickByJS(Admin.getNav_Admin_ManageTab());
	    	    
	    	 	WebObjectUtil.clickByJS(Admin.getNav_Admin_GotoTab());
	    	    WebObjectUtil.clickByJS(Admin.getNav_Admin_Goto_ControlPanelLink());
	    	 	//WebObjectUtil.clickElement(Admin.getNav_Admin_GotoTab());
	    	 	//WebObjectUtil.clickElement(Admin.getNav_Admin_Goto_ControlPanelLink());
		...
		public static void navAdminClickActionsButtonOrg(String sOrganization)
		{
				WebDriver driver = WebDriverUtil.getDriver();
				PageFactory.initElements(driver,Admin);
				WebElement wRowOrgElement,wRowActionsButton;
				int iRowNumber=0,iRowOrg=0;
					
	     try {
	        	//CustomWebElementUtil.loadCustomElement(Admin.getNav_Admin_OrganizationsParentWebTable(), "tr");
	    	    CustomWebElementUtil.loadCustomElement(Admin.getNav_Admin_SubOrgParentWebTable(), "tr");
	    	    iRowNumber=CustomWebElementUtil.iRowCount;
			    //iRowNumber = CustomWebElementUtil.getRowByCellText(sOrganization,1);
	    	    FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName , "Notes", "warn", "Below warning is to pick the passed organization from organizations table" );  
	    	    for(int i=1;i<=iRowNumber;i++)
	    	    {
	    	    	wRowOrgElement = WebObjectUtil.getWebElementFromDynamicLocator("xpath","ADMIN.MANAGE.CONTROLPANEL.ORGS.ORGTABLE.ORGANIZATIONROW", "PARAMETER_ROWNUMBER,PARAMETER_ORG", i+","+sOrganization);
	    	    	if(wRowOrgElement!=null)
	    	    	{
	    	    		iRowOrg=i;
	    	    		break;
	    	    	}
			    ...
			    wRowActionsButton = WebObjectUtil.getWebElementFromDynamicLocator("xpath","ADMIN.MANAGE.CONTROLPANEL.ORGS.ORGTABLE.ACTIONSBUTTON", "PARAMETER_ROWNUMBER", iRowOrg+"");
			   // WebObjectUtil.scrollElementAtPageCenter(wRowActionsButton);
		    ...
		    try {
				  ...
				  //verifies whether entities matches in EB and EM 
				   if(iChildOrgCount == iChildOrgEBCount )
				   {
					   ...
					   FrameworkUtil.sElementName="Entity selected has children";
					   FrameworkUtil.updateCustomResultBasedOnStatus(bStatus, "Child Organizations are Matching in Entity browser and entity management table for " +sFLCOrgData);
				   }
				   else{
					   FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName, "ChildOrgs", "fail", "Child Organizations are not matching in entity browser and entity management table for" +sFLCOrgData); 
				   }
		...
		public static void verifyOrg(String sChildorg,String sParentorg)
		{
		 ...
		 String sUrl = (String)FrameworkUtil.dictPropertyData.get("NAV.QA.UPGRADE.URL"); 	
			...
			try {
				...
				WebObjectUtil.clickElement(Admin.getUpgrade_EntityMgtDropdownArrow());
				//WebObjectUtil.clickByJS(Admin.getUpgrade_EntityMgtDropdownArrow());
				WebObjectUtil.SetValueEdit(Admin.getUpgrade_EntityMgtOrgEdit(), sChildorg);
				WebObjectUtil.explicitWait(10);
      ...
      =====================================================================================================*/
		...
		/*====================================================================================================
		Method Name 	: navAdminClickOrgLink
		Description		: Clicking on org link with respect to selected organization in Organization Table
		Author 			: QAA03
		Creation Date 	: 05/20/2016s
		Pre-Requisites	:
		Revision History:
		====================================================================================================*/
		public static void navAdminClickOrgLink(String sOrganization)
		{
				WebDriver driver = WebDriverUtil.getDriver();
				PageFactory.initElements(driver,Admin);
				WebElement wRowOrgLink;
				int iRowNumber=0;
	     ...
	     try {
			   ...
			   // wRowActionsButton = WebObjectUtil.getWebElementFromDynamicLocator("xpath","ADMIN.MANAGE.CONTROLPANEL.ORGS.ORGTABLE.ACTIONSBUTTON", "PARAMETER_ROWNUMBER", iRowNumber+"");
			    wRowOrgLink = WebObjectUtil.getWebElementFromDynamicLocator("xpath","ADMIN.MANAGE.CONTROLPANEL.ORGS.ORGTABLE.ORGLINK", "PARAMETER_ROWNUMBER", iRowNumber+"");
				WebObjectUtil.clickElement(wRowOrgLink);
