...
public class UserPermissionTestCase {
	...
	public void accessToMountMedia(){
		...
		//Updated to qaauto user as per client request by Arul on 7/12/16
	...
	public static void AccessToUserManagement(String sUserName,String sPassword){
		...
		if (WebDriverUtil.browser.equalsIgnoreCase("ie")){
			String sUMUrl = (String)FrameworkUtil.dictPropertyData.get("NAV.PERMISSIONLINK.URL");
			...
			//WebObjectUtil.mouseHoverByJS(UserPermission.getNav_AccountLink());
...
*/
		...
		*/
		...
		//WebObjectUtil.selectCustomWebList(UserPermission.getNav_UserRoleDropDown(), sRole2);
			...
			wUserRoleWebList = WebObjectUtil.getActiveElementasWebElement(sULElementXpath);
			WebObjectUtil.explicitWait(2);
			if (wUserRoleWebList == null){
	  		...
	  		WebObjectUtil.selectCustomWebList(wUserRoleWebList, sRole2);
...
/*			do
	  		...
	  		//sUserRoleDropDownLocator = "//tr[" + iRowNo + "]//td//div//div[contains(@class,'x-form-trigger x-form-trigger-default x-form-arrow-trigger x-form-arrow-trigger-default')]/..";
	  		sUserRoleDropDownLocator="//div[@class='x-boundlist-list-ct x-unselectable']/ul/li[text()='"+ sRole2 +"']";
	  		wUserRoleDropDown = WebObjectUtil.GetWebElement("xpath", sUserRoleDropDownLocator, "UserRoleDropDown");
	  		}
	  		while (wUserRoleDropDown == null || iLoopcount >=3);
	  		
	  		
	  		
	  		WebObjectUtil.explicitWait(2);
	  		//WebObjectUtil.ClickAndMouseHover(sUserRoleDropDown);
	  		WebObjectUtil.clickElement(wUserRoleDropDown);	*/
		sRoleName = sRole2;
		}else{
		//WebObjectUtil.selectCustomWebList(UserPermission.getNav_UserRoleDropDown(), sRole1);
			...
			if (wUserRoleWebList == null){
	  		...
	  		WebObjectUtil.selectCustomWebList(wUserRoleWebList, sRole1);
...
/*			do
	  		...
	  		//sUserRoleDropDownLocator = "//tr[" + iRowNo + "]//td//div//div[contains(@class,'x-form-trigger x-form-trigger-default x-form-arrow-trigger x-form-arrow-trigger-default')]/..";
	  		sUserRoleDropDownLocator="//div[@class='x-boundlist-list-ct x-unselectable']/ul/li[text()='"+ sRole1 +"']";
	  		wUserRoleDropDown = WebObjectUtil.GetWebElement("xpath", sUserRoleDropDownLocator, "UserRoleDropDown");
	  		}
	  		while (wUserRoleDropDown == null || iLoopcount >=3);
	...
	public static void editRoleManageRoles(String sNewRoleName){
		...
		sEditSuccessMsg = (String)FrameworkUtil.dictPropertyData.get("NAV.USERROLE.EDITROLE.SUCCESSMSG");
			...
			WebObjectUtil.scrollToElement(UserPermission.getNav_EditRole_AddUserCheckBox());
	...
	static WebElement getRoleElementByIndex(int iRoleIndex, String sSearchText){
		...
		@Test(priority=10)
	      public void AccessToCreateTicketTest(){
	            ...
	            FrameworkUtil.sTestCaseName = "UserPermissions-AccessToCreateTicketTest";
	      ...
	      @Test(priority=0)
		  	public void setUserRole(){
		  		...
		  		setUserPermission("qaauto-a",sRoleAdmin);
		  		setUserPermission("qaauto-c",sRoleUser);
		  		setUserPermission("qaauto-e",sRoleObserver);
		  		LoginTestCase_Old1.nav_Logout();
...
/////############################################# vivek  #############################################################
		  	...
		  	public void navCatalogViewWSandPrivate()
		  	{
		  		...
		  		//Login to Navigator with E -Role
		  		//LoginTestCase.nav_Login(sUserName,sPassword);
		  		//As per client request - Changing HostedSol to QaAuto Org
		  		LoginTestCase_Old1.LoginAsQaautoAUser();
		  	...
		  	//	sPassword=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MANAGEMENT.PASSWORD.CROLE");
		  		//Login to Navigator with E -Role
		  		//LoginTestCase.nav_Login(sUserName,sPassword);
		  		//LoginTestCase.LoginAsARoleCUser();
		  	//As per client request - Changing HostedSol to QaAuto Org 
		  		//only comment was there but still rolec user was there - updated with qaautoC  by Arul on 12 Jul 16
		  		LoginTestCase_Old1.LoginAsQaautoCUser();
	...
	//#######################################################################################################	
		...
		public void navEVDCViewVM(String sUserName,String sPassword)
		{
			...
			WebObjectUtil.clickElement(UserPermission.getNav_EVDCOrgSelector());
			//WebObjectUtil.explicitWait(3);
		...
		public void navEditDescriptionUpdate(int iRowNbr,String sUserName)
		{
			...
			try {
				sTestDescription = sTestDescription + FrameworkUtil.getCurrentTimeStamp();
				sVMName=EVDC_VM_TestCase.navGetVMName(iRowNbr);
...
//####################################  Sukur   ####################################################
		...
		public void AccessToAddUser()
		{
			...
			LoginTestCase_Old1.nav_Login(sUserNameA, sPasswordA);
...
/*			WebObjectUtil.waitForElementPresent(UserPermission.getNav_AddUserRoleLink());
			...
			LoginTestCase_Old1.nav_Login(sUserNameC, sPasswordC);
			//Navigate to Critical Escalation list page
			NavigateToCriticalEscalationListPage();
			//Click on Authorization Contact List tab
			WebObjectUtil.clickElement(UserPermission.getNav_AuthorizedContactListTab());
...
/*			WebObjectUtil.waitForElementPresent(UserPermission.getNav_AddUserRoleLink());
			...
			LoginTestCase_Old1.nav_Login(sUserNameE, sPasswordE);
			//Navigate to Critical Escalation list page
			NavigateToCriticalEscalationListPage();
			//Click on Authorization Contact List tab
			WebObjectUtil.clickElement(UserPermission.getNav_AuthorizedContactListTab());
	...
	/*	@Test(priority=103)
		...
		public void AccessToDeleteUser()
		{
			...
			try {
				...
				FrameworkUtil.updateTestCaseNameinResult(FrameworkUtil.sTestCaseName,FrameworkUtil.sManualTestCaseName);
				//Log into Navigaotr
				LoginTestCase_Old1.nav_Login(sUserName1, sPassword1);
				//Navigate to Critical Escalation list page
				...
				WebElement DeleteLinkWebElement = WebObjectUtil.GetWebElement("xpath", "//table["+RowNumber+"]//div/a[@class='greenlink']","Delete Link");
				...
				int iAutRowno = CustomWebElementUtil.getRowByCellText(sUserToDelete, 1);
				
				WebElement wAutRow =WebObjectUtil.getWebElementFromDynamicLocator("xpath","NAV.ESCALATION.AUTHORIZED.ROWARROW","PARAMETER_ROWNUMBER",iAutRowno+"");
				WebObjectUtil.clickElement(wAutRow);
				
				WebObjectUtil.clickElement(UserPermission.getNav_AddtoCriticalEscalationListLink());
				WebObjectUtil.verifyElementPresent(UserPermission.getNav_PopupWindow());
...
/*			WebObjectUtil.clickAndVerifyElement(smokeTest.getNav_SupportMenuLink(), smokeTest.getNav_BuildReq_Forms_SubMenuLink());
	...
	/*	@Test(priority=1010)
		...
		public void AccessToAddDriveTest()
	      {
	            ...
	            FrameworkUtil.sTestCaseName = "UserPermissions-AccessToAddDriveTest";
		...
		public static void AccessToAddFirewallRuleTest(){
			{
				try {
					...
					FrameworkUtil.sTestCaseName = "UserPermissions-AccessToAddFirewallRuleTest";
		...
		public static void NoAccessToViewForms(String sUserName,String sPassword,String sFormsUserId,String sFormsPassword){
			PageFactory.initElements(WebDriverUtil.getDriver(), UserPermission);
			LoginTestCase_Old1.nav_Login(sUserName, sPassword);
			WebObjectUtil.ClickAndMouseHover(UserPermission.getNav_SupportTab());
		}
		...
		public static void NavigateToEscalationListPage()
		{
			...
			try {
				if (WebDriverUtil.browser.equalsIgnoreCase("ie")){
					String sUMUrl = (String)FrameworkUtil.dictPropertyData.get("NAV.ESCLATIONLISTMENULINK.URL");
					WebDriverUtil.getDriver().get(sUMUrl);
				}else{
				//LoginTestCase.nav_Login(sUserName, sPassword);
		...
		{
			PageFactory.initElements(WebDriverUtil.getDriver(), smokeTest);
			try {
				if (WebDriverUtil.browser.equalsIgnoreCase("ie")){
					String sUMUrl = (String)FrameworkUtil.dictPropertyData.get("NAV.FORMSLINK.URL");
					WebDriverUtil.getDriver().get(sUMUrl);
				}else{
				WebObjectUtil.clickAndVerifyElement(smokeTest.getNav_SupportMenuLink(), smokeTest.getNav_BuildReq_Forms_SubMenuLink());
				WebObjectUtil.explicitWait(5);
		...
		public void editRoleBeforeAssignToUser(){
			...
			WebDriver driver = WebDriverUtil.getDriver();
			PageFactory.initElements(driver, UserPermissionTestCase.UserPermission);
			FrameworkUtil.sTestCaseName = "UserPermission-editRoleBeforeAssignToUser";
			FrameworkUtil.sManualTestCaseName="CPPOC3452-Verify that the user is able to see permissions correctly with the updated custom role";
			FrameworkUtil.updateTestCaseNameinResult(FrameworkUtil.sTestCaseName,FrameworkUtil.sManualTestCaseName);
		...
		*/	
		...
		//sRoleSaveAs =  (String)FrameworkUtil.dictPropertyData.get("NAV.USERROLE.NEWROLENAME")+ FrameworkUtil.sTimeStamp;
			...
			//setUserPermission(sUser_Name, sNewRoleName);
		...
		public void editRoleAfterAssignToUser(){
			...
			WebDriver driver = WebDriverUtil.getDriver();
			PageFactory.initElements(driver, UserPermissionTestCase.UserPermission);
			FrameworkUtil.sTestCaseName = "UserPermission-editRoleAfterAssignToUser";
			FrameworkUtil.sManualTestCaseName="CPPOC3448-Verify that the user is able to see permissions correctly with the updated custom role";
			FrameworkUtil.updateTestCaseNameinResult(FrameworkUtil.sTestCaseName,FrameworkUtil.sManualTestCaseName);
	...
	/*
		...
		public static void editUserPermission(String sRoleName,String sUserName){
			...
			//System.out.println(row.getText());
	  		...
	  		sUserRoleWebList = WebObjectUtil.getActiveElementasWebElement(sULElementXpath);
	  		WebObjectUtil.selectCustomWebList(sUserRoleWebList, sRoleName);
		...
		/*	//sUserRoleWebListLocator = "//tr[" + iRowNo + "]//td[4]//div[contains(@class,'x-grid-cell-inner')]";
			...
			sUserRoleWebListLocator = "//div[@id='userListPanel-body']//table[" + iRowNo + "]/tbody/tr/td[4]/div[contains(@class,'x-grid-cell-inner')]";
	  		...
	  		//sUserRoleDropDownLocator = "//tr[" + iRowNo + "]//td//div//div[contains(@class,'x-form-trigger x-form-trigger-default x-form-arrow-trigger x-form-arrow-trigger-default')]/..";
	  		sUserRoleDropDownLocator="//div[@class='x-boundlist-list-ct x-unselectable']/ul/li[text()='"+ sRoleName +"']";
	  		sUserRoleDropDown = WebObjectUtil.GetWebElement("xpath", sUserRoleDropDownLocator, "UserRoleDropDown");
	  		}
	  		while (sUserRoleDropDown == null || iLoopcount >=3);
...
/*==============================================================
TestScript  	: CreateAndVerifyEscalationAddUserTicket
Manual TestCase	: QAT-1460 WCP_3415_TC_1.2_Ticket watchers_Escalation List_ACL Tab_Add User ticket.
Description		: 
Author 			: QAA03
Creation Date 	: 01/06/2016
Release Name    : OOS
Coverage        : Step 12 to Step 17 automated
Pre-Requisites	: 
Revision History:
==============================================================*/
	
@Test(priority=10)
public void createAndVerifyEscalationAddUserTicket()
{
				WebDriver driver = WebDriverUtil.getDriver();
				PageFactory.initElements(driver,UserPermission);
				PageFactory.initElements(driver,Ticket);
			...
			try {
				FrameworkUtil.sTestCaseName = "createAndVerifyEscalationAddUserTicket";
				FrameworkUtil.sManualTestCaseName="QAT-1460 WCP_3415_TC_1.2_Ticket watchers_Escalation List_ACL Tab_Add User ticket.";
				FrameworkUtil.updateTestCaseNameinResult(FrameworkUtil.sTestCaseName,FrameworkUtil.sManualTestCaseName);
				
				//Login to Navigator with entity02a user
				...
				//Entering add user fields and creating the ticket
				
				sTicketID = enterAllRequiredFieldsInAddUserPopupWindow();
				
				TicketTestCase.navigateToTicketPage();
				
				//Searching the created ticket in the tickets page
				...
				LoggerUtil.log_type_error("catch block:" + FrameworkUtil.sElementName);
				FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName , "createAndVerifyEscalationAddUserTicket", "warn", "catch block:" +e.getMessage());
		}
	}
...
//////////////////////////////////////////////////OOS ////////////////////////////////////////////
/*====================================================================================================
Method Name 	: enterAllRequiredFieldsInAddUserPopupWindow
Description		: Enter all required Fields in Add User Popup Window
Author 			: QAA03
Creation Date 	: 06/01/2016
Pre-Requisites	:
Revision History:
=====================================================================================================*/
	public static String enterAllRequiredFieldsInAddUserPopupWindow()
		{
		String sFirstName=null,sLastName=null,sEmailAddress=null,sPhone=null,sCell=null;
		String sPopupMsg=null,sPopUpMessage=null,sPopUp[],sTicketID=null;
		WebDriver driver= WebDriverUtil.getDriver();
		PageFactory.initElements(driver, UserPermission);
		
		try {
		sFirstName = (String)FrameworkUtil.dictPropertyData.get("NAV.ESCALATION.ADDUSER.FIRSTNAME");
		sLastName = (String)FrameworkUtil.dictPropertyData.get("NAV.ESCALATION.ADDUSER.LASTNAME");
		sEmailAddress = (String)FrameworkUtil.dictPropertyData.get("NAV.ESCALATION.ADDUSER.EMAIL");
		sPhone = (String)FrameworkUtil.dictPropertyData.get("NAV.ESCALATION.ADDUSER.PHONE");
		sCell = (String)FrameworkUtil.dictPropertyData.get("NAV.ESCALATION.ADDUSER.CELL");
		sPopupMsg = (String)FrameworkUtil.dictPropertyData.get("NAV.ESCALATION.ADDUSER.POPUPMSG");
		...
		WebObjectUtil.clickElement(UserPermission.getNav_AddUserOKbtn());
		WebObjectUtil.explicitWait(10);
		WebObjectUtil.VerifyTextUnderElement(UserPermission.getNav_popupMsg(), sPopupMsg);
		sPopUpMessage =UserPermission.getNav_popupMsg().getText();
		sPopUp = sPopUpMessage.split(":");
		WebObjectUtil.clickElement(UserPermission.getNav_ConfirmPopupOkBtn());
		WebObjectUtil.VerifyTextUnderElement(UserPermission.getNav_FeedBackArea(), sPopupMsg);
		sTicketID = sPopUp[1].trim();
		
		} catch (Exception e) {
		LoggerUtil.log_type_error("catch block:" + FrameworkUtil.sElementName);
		FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName , "enterAllRequiredFieldsInAddUserPopupWindow", "warn", "catch block:" +e.getMessage());
		}
		return sTicketID;
		}
