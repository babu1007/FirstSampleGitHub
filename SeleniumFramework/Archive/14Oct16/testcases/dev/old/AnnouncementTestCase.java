...
public void verifyAnnouncementCreatedinViewcalendarAndViewboard()
{
		...
		try {
				...
				//sAnnouncementTitle ="SeleniumTest20160509_084301";	
				//sAnnouncementDetail="SeleniumTest20160509_084301www.google.com";
...
public static void verifyCreatedAnnouncementonHomepage()
{
			 ...
			 try {
				  ...
				  //Login to navigator with qaauto-C user
				   LoginTestCase.LoginAsQaautoCUser();
...
Manual TestCase	: [QAT-1355] WCP_4651_TC_1.0_ Announcement - BCC email list
Description		: 
Author 			: QAA03
...
public void verifyAnnouncementCreatedwithEmail()
{
				...
				String sAnnouncementDate=null,sAnnouncementTitle=null,sTommorrowDate=null,sCategory=null,sSubCategory=null,sEmail=null,sCurrentDate=null;
		...
		try {
				...
				sTommorrowDate=getTommorrowDate();
				//sAnnouncementTitle="SeleniumTest20160525_063016";
				...
				verifyAnnouncementonCreatedDateinViewcalendar(sTommorrowDate, sAnnouncementTitle," ");
				...
				verifyAnnouncementDatainIndexOfHostsUrl(sCurrentDate, sAnnouncementTitle, sEmail);
...
public static void verifyAnnouncementTextafterClickingonlinkinViewCalendar(String sAnnouncementTitle,String sAnnouncementDetail)
{
			 ...
			 try {
				    ...
				    {		    	
				    	...
				    	bAnnLinkstatus = sAnnouncementText.contains(sAnnouncementTitle)&& sAnnouncementText.contains(sAnnDetailText[0]);
				    }
				    else
				    {
				    	sAnnouncementText = Announcement.getNav_ViewcalendarViewAnnouncement().getText();
...
Revision History:
====================================================================================================*/
public static void validateAddNewAnnouncementwithEmailField(String sAnnouncementDate,String sAnnouncementTitle,String sCategory,String sSubCategory,String sEmail)
{
				    WebDriver driver = WebDriverUtil.getDriver();
				 	PageFactory.initElements(driver,Announcement);
					PageFactory.initElements(driver,Common);
...
public static void verifyAnnDatainLogViewerEmailwindow(String sAnnouncementTitle,String sAdminEmail,String sEmail)
{
			 ...
			 try {
				    ...
				    bAnnSubStatus =Logviewer.getNav_LogViewerEmailContentWindowSubjectText().getAttribute("value").contains(sAnnouncementTitle);
