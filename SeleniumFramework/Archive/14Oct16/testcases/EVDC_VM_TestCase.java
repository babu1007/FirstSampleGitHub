...
/*					WebObjectUtil.scrollToElement(EVDC_OverviewPF.getNav_VMCountNumberLink());
					WebObjectUtil.clickByActions(EVDC_OverviewPF.getNav_VMCountNumberLink());
					WebObjectUtil.clickByJS(EVDC_OverviewPF.getNav_VMCountNumberLink());*/
...
//-------///Clicking Stop Button and verifying the userfeedback msg
	...
	public void EVDC_CreateTicket(){
		...
		try {
			...
			FrameworkUtil.sTestCaseName = "EVDC-CreateTicket";
...
==============================================================*/
	...
	public void verifyNoNetworksAddVM()
	{
		...
		try {
			...
			sBlankVMName =sVMName + "_" + FrameworkUtil.date_yyyyMMdd()+ "_" + FrameworkUtil.date_HHmmss();
			...
			// Clicking on Add Virtual Machine Link
			WebObjectUtil.clickAndVerifyElement(EVDC_VMPF.getNav_AddVMLink(), EVDC_VMPF.getNav_AddVMSelectVMType());
			sTemplateVMName =sVMName + "_" + FrameworkUtil.date_yyyyMMdd()+ "_" + FrameworkUtil.date_HHmmss();
...
==============================================================*/
	...
	public void VerifyVMPortlet()
	{
	    ...
	    WebObjectUtil.explicitWait(5);		
	    sVMName_Template=sVMName + "_" + FrameworkUtil.date_yyyyMMdd()+ "_" + FrameworkUtil.date_HHmmss();
...
/*		WebDriverUtil.refreshBrowser();
	...
	public static boolean navEVDCValExpectedActualMsg(String sExpectedMsg,String sActualMsg)
	{
		boolean flag=false;
		try {
			//below 3 parameter changed to false to verify feedback msg contains instead of equal by Arul on 07/20/16
			if(WebObjectUtil.compareString(sExpectedMsg, sActualMsg, false))
			{
...
/// _________________________________ Lef Court test cases _____________________________________ ////
...
public void navVerifyVMGridColors(){
   ...
   // return to home
   HomeTestCase.navReturnToHamePage();
...
///______________________________ Completed lefcourt test cases ___________________________________ ///

/// ____________________________ Kyle test cases _____________________________________////
...
public void verifyEVDCStorageProfile()
{
	...
	try {
		...
		wStorageProfile=WebObjectUtil.getWebElementFromDynamicLocator("xpath", "NAV.EVDC.VM.STORAGE.PROFILE", "PARAMETER_ROWNUMBER", iRowNo+"");
		 ...
		 bStatus = FirewallTestCase_GOM.GOMCreateObjectToolTipMsg(wStorageProfile, "data-qtip", "HOSTEDSOL-CPTY-ENCRYPT-REPNONE");
...
//// ___________________________ Completed kyle test cases ______________________________ ////	
