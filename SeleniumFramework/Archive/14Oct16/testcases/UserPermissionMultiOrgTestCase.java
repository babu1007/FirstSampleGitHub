...
public class UserPermissionMultiOrgTestCase {
	...
	static HomePageFactory_old HomePageFactory = new HomePageFactory_old();
...
////#########################################################Vivek start##############################################
	...
	public void navVerDocumentWithMultiOrg()
	{
		...
		WebDriver driver = WebDriverUtil.getDriver();
  		...
  		FrameworkUtil.sTestCaseName = "MultiOrg-navVerDocumentWithMultiOrg";
  		...
  		sUserName=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.USERID.QAAUTOM");
  		sPassword=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.PWD.QAAUTOM");
  		...
  		if(!selectOrgs(sOrgName))
        {
        	selectOrgnameInOrgSelector(sOrgName);
        }
  		//selectOrgnameInOrgSelector(sOrgName);
  		...
  		sOrgName=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME.TSTQAAUTO");
  	    //switchOraganization(sOrgName);
  		if(!selectOrgs(sOrgName))
        {
        	selectOrgnameInOrgSelector(sOrgName);
  		...
  		sUserName=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.USERID.QAAUTOMC");
  		sPassword=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.PWD.QAAUTOMC");
  		...
  		if(!selectOrgs(sOrgName))
        {
  		...
  		sUserName=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.USERID.QAAUTOME");
  		sPassword=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.PWD.QAAUTOME");
	...
	public void navVerAnnouncementWithMultiOrg()
	{
		...
		WebDriver driver = WebDriverUtil.getDriver();
  		PageFactory.initElements(driver, UserPermission);
  		PageFactory.initElements(driver, UPMultiOrg);
  		FrameworkUtil.sTestCaseName = "MultiOrg-navVerAnnouncementWithMultiOrg";
	...
	public void navVerCloudAPIWithMultiOrg()
	{
		...
		WebDriver driver = WebDriverUtil.getDriver();
  		PageFactory.initElements(driver, UserPermission);
  		PageFactory.initElements(driver, UPMultiOrg);
  		FrameworkUtil.sTestCaseName = "MultiOrg-navVerCloudAPIWithMultiOrg";
	...
	public void navVerCloudAVWithMultiOrg()
	{
		...
		WebDriver driver = WebDriverUtil.getDriver();
  		PageFactory.initElements(driver, UserPermission);
  		PageFactory.initElements(driver, UPMultiOrg);
  		FrameworkUtil.sTestCaseName = "MultiOrg-navVerCloudAVWithMultiOrg";
	...
	public void navVerDDoSMitigationWithMultiOrg()
	{
		...
		WebDriver driver = WebDriverUtil.getDriver();
  		PageFactory.initElements(driver, UserPermission);
  		PageFactory.initElements(driver, UPMultiOrg);
  		FrameworkUtil.sTestCaseName = "MultiOrg-navVerDDoSMitigationWithMultiOrg";
...
////?????????????????????????????????????????Sukur start????????????????????????????????????????????????????????????????
	...
	public void multiOrgUserAccessToEscaltionListpage()
	{
		...
		FrameworkUtil.sTestCaseName = "MultiOrg-multiOrgUserAccessToEscaltionListpage";
		...
		sOrgName2=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME.TSTQAAUTO");
		loginNavigator(sUserName,sPassword);
		NavigateToCriticalEscalationListPage();
		//selectOrgs(sOrgName0);
		verifyEscalationDataForMultiOrg(sGiraffsEscalationData);
		//selectOrgs(sOrgName1);
		//selectOrgnameInOrgSelector(sOrgName1);
		if(!selectOrgs(sOrgName1))
        {
        	selectOrgnameInOrgSelector(sOrgName1);
        }
		verifyEscalationDataForMultiOrg(sTstDevcoEscalationData);
		//selectOrgs(sOrgName2);
		//selectOrgnameInOrgSelector(sOrgName2);
		if(!selectOrgs(sOrgName2))
        {
        	selectOrgnameInOrgSelector(sOrgName2);
        }
		LoginTestCase_Old1.nav_Logout();
	...
	public void multiOrgUserAccessToEVDCOverviewpage()
	{
		...
		PageFactory.initElements(driver, UserPerm);	
		PageFactory.initElements(driver, UPMultiOrg);
		String sUserName,sPassword,sOrgName11Giraffes,sOrgNameTstDevco,sOrgNameTstqaauto,sOrgText,sExpEVDCqaautoItem,sExpEVDC11GirItem,sExpEVDCTstDevcoItem;
		
		FrameworkUtil.sTestCaseName = "MultiOrg-multiOrgUserAccessToEVDCOverviewpage";
		...
		sOrgNameTstqaauto=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME.TSTQAAUTO");
		sExpEVDCqaautoItem=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.EVDC.TSTQAAUTO.ORG.NAME");
		...
		if(!selectOrgs(sOrgNameTstDevco))
		{
		selectOrgnameInOrgSelector(sOrgNameTstDevco);
		}
		...
		if(!selectOrgs(sOrgNameTstqaauto))
		{
		selectOrgnameInOrgSelector(sOrgNameTstqaauto);
		}
		verifyEVDCDropdownItem(sExpEVDCqaautoItem);
		selectEVDC(sExpEVDCqaautoItem);
		verifyEVDCPageReflectsDataAsperOrg(sExpEVDCqaautoItem);
		LoginTestCase_Old1.nav_Logout();
		/*sUserName=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.USERID.CROLE");
  		sPassword=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.PASSWORD.CROLE");*/
	...
	public void multiOrgUserAccessToEVDCVMpage()
	{
		...
		PageFactory.initElements(driver, UserPerm);	
		PageFactory.initElements(driver, UPMultiOrg);
		String sUserName,sPassword,sOrgName1,sOrgName2,sOrgText,sGiraffsVMData,sTstDevcoVMData,sExpEVDCqaautoItem,sExpEVDC11GirItem,sExpEVDCTstDevcoItem;
		String sOrgNameTstDevco,sOrgNameTstqaauto;
		FrameworkUtil.sTestCaseName = "MultiOrg-multiOrgUserAccessToEVDCVMpage";
	...
	public void multiOrgUserAccessToEVDCCatalogpage()
	{
		...
		PageFactory.initElements(driver, UserPerm);	
		PageFactory.initElements(driver, UPMultiOrg);
		String sUserName,sPassword,sOrgName1,sOrgName2,sOrgText,sGiraffsCtlgData,sTstDevcoCtlgData,sExpEVDCqaautoItem,sExpEVDC11GirItem,sExpEVDCTstDevcoItem;
		String sOrgNameTstDevco,sOrgNameTstqaauto;
		
		FrameworkUtil.sTestCaseName = "MultiOrg-multiOrgUserAccessToEVDCCatalogpage";
	...
	public void multiOrgUserAccessToEVDCFirewallpage()
	{
		...
		PageFactory.initElements(driver, UserPerm);	
		PageFactory.initElements(driver, UPMultiOrg);
		String sUserName,sPassword,sOrgName1,sOrgName2,sOrgText,sGiraffsFirewallData,sTstDevcoFirewallData,sExpEVDCQaautoItem,sExpEVDC11GirItem,sExpEVDCTstDevcoItem;
		String sOrgNameTstDevco,sOrgNameTstqaauto;
		
		FrameworkUtil.sTestCaseName = "MultiOrg-multiOrgUserAccessToEVDCFirewallpage";
	    ...
	    WebObjectUtil.clickElement(UPMultiOrg.getNav_HomeBreadCrumbLink());
		WebObjectUtil.explicitWait(5);
		NavigateToFirewallPage();
		selectEVDC(sExpEVDCTstDevcoItem);
	...
	public void multiOrgUserAccessToDNSpage()
	{
		...
		FrameworkUtil.sTestCaseName = "MultiOrg-multiOrgUserAccessToDNSpage";
	...
	public static void loginNavigator(String sUserName,String sPassword){
		...
		try{
			...
			//added as workaround to avoid login page loading issue by ARul on 07/28/16, should be removed once issue resolved
			WebDriverUtil.getDriver().get("https://tst-lab2-navigator02.lab.hostedsolutions.com/orgselector/");
...
try{
	...
	public static boolean selectOrgs(String sOrgName){
		PageFactory.initElements(WebDriverUtil.getDriver(), UPMultiOrg);
		boolean bOrgname=false;
		try{
			String sOrgText;
			WebElement wOrgItem;
			//sOrgName1=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME2");
			...
			if(wOrgItem!=null)
			{
				...
				sOrgText=UPMultiOrg.getNav_OrganizationnameLink().getText();
				bOrgname=sOrgText.equalsIgnoreCase(sOrgName);
                //FrameworkUtil.updateCustomResultBasedOnStatus(bOrgname, sOrgText + " organization displayed after selction" );

				if(bOrgname)
				{
					FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName, "organization selected", "pass", sOrgText + " organization displayed after selection");
				}
				else
				{
					FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName, "organization selected", "warn", sOrgText + " organization displayed after selection");
				}
			...
			LoggerUtil.log_type_error(e.getMessage());
			FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName , "Exception occured", "warn", e.getMessage()+"null");
		}
		return bOrgname;
	}
	/*==============================================================
...
public static void elementHighlight(WebElement element) {
	...
	{
		WebElement wEVDCElement;
		String sEVDCName=null;
		
		sEVDCName=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.EVDC.TSTDEVCO.ORG.NAME");
		PageFactory.initElements(WebDriverUtil.getDriver(), UPMultiOrg);
		PageFactory.initElements(WebDriverUtil.getDriver(), UserPerm);
		PageFactory.initElements(WebDriverUtil.getDriver(), EVDC_OverviewPF);
		
		//WebObjectUtil.clickElement(UserPerm.getNav_EVDCPortalLink());
		//The below lines updated by QAA03 on 05/12/2016
		//WebObjectUtil.clickElement(EVDC_OverviewPF.getNav_EVDCname());
		wEVDCElement = EVDC_VM_TestCase.getEVDCNameAsWebElement(sEVDCName);
		WebObjectUtil.clickElement(wEVDCElement);
		WebObjectUtil.waitForElementPresent(UserPerm.getNav_FirewallLink());
...
////?????????????????????????????????????????Sukur end????????????????????????????????????????????????????????????????
    ...
    VerifyMultiOrgsHomePage();
 	...
 	//LoginTestCase.nav_Login(sUserName1, sPassword1);
 	LoginTestCase_Old1.LoginAsQaautoMCMultiOrgUser();
 	navigateHomePage();
 	VerifyMultiOrgsHomePage();
 	LoginTestCase_Old1.nav_Logout();
 	...
 	//LoginTestCase.nav_Login(sUserName1, sPassword1);
 	LoginTestCase_Old1.LoginAsQaautoMEMultiOrgUser();
 	navigateHomePage();
 	VerifyMultiOrgsHomePage();
 	LoginTestCase_Old1.nav_Logout();
	}
	...
	public static void VerifyMultiOrgsHomePage()
	{
        ...
        try{
            String sOrg1,sOrg2,sOrg3,x,sTNum1,sTNum2,sTNum3;
            
        	WebObjectUtil.explicitWait(15);
        	//WebObjectUtil.ClickAndMouseHover(UPMultiOrg.getNav_OrganizationnameLink());
            x=UPMultiOrg.getNav_OrganizationnameLink().getText();
            sOrg1=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME1");
            if(sOrg1.equalsIgnoreCase(x))
            FrameworkUtil.updateCustomResultBasedOnStatus(true, sOrg1 + " organization displayed after selction" );
            else
            FrameworkUtil.updateCustomResultBasedOnStatus(false, sOrg1 + " organization not displayed after selction" );
            ...
            sOrg2=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME2");
           
            
            if(!selectOrgs(sOrg2))
            {
            	selectOrgnameInOrgSelector(sOrg2);
            }
            ...
            sOrg3=(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME.TSTQAAUTO");
            
            if(!selectOrgs(sOrg3))
            {
            	selectOrgnameInOrgSelector(sOrg3);
            }
	...
	public static void VerifyMultiOrgsTicketsPage()
	{
        ...
        try{
          ...
          //This below line updated on 10/07/2015 for EXTJS5 by QAA03
    		...
    		wOrgname=WebObjectUtil.GetWebElement("xpath", "//table[1]//table//td/div[@id='ticket_content']/dl/dt[text()='Organization']/../dd", "Organization name");
    		j=wOrgname.getText();
    		...
    		if(!selectOrgs(sOrg))
    		{
            selectOrgnameInOrgSelector(sOrg);
    		}
        	//This below line updated on 10/07/2015 for EXTJS5 by QAA03
    		//wExpander=WebObjectUtil.GetWebElement("xpath", "//table/tbody/tr["+1+"]//tr[1]/td[1]//div[@class='x-grid-row-expander']", "Arrow Expander");
        	wExpander=WebObjectUtil.GetWebElement("xpath", "//div[@id='idTicketsGridPanel-body']/div/div/table[1]/tbody/tr/td/div/div[@class='x-grid-row-expander']", "Ticket Arrow Expander"); 
        	...
        	if(j.equalsIgnoreCase(sOrg))
                ...
                FrameworkUtil.updateCustomResultBasedOnStatus(false, sOrg + " organization not displayed after selction" );
        	sOrg =(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME.TSTQAAUTO");
    		...
    		//This below line updated on 10/07/2015 for EXTJS5 by QAA03
    		//j=WebObjectUtil.GetWebElement("xpath", "//tr["+1+"]/td/table/tbody/tr[2]/td/div/div/section/table/tbody/tr[5]/td/div[2]/dl/dd", "Org Name").getText();
    		//j=WebObjectUtil.GetWebElement("xpath", "//table[1]//table//td/div[@id='ticket_content']/dl/dt[text()='Organization']/../dd", "Organization name").getText();
    		wOrgname=WebObjectUtil.GetWebElement("xpath", "//table[1]//table//td/div[@id='ticket_content']/dl/dt[text()='Organization']/../dd", "Organization name");
    		j=wOrgname.getText();
        	if(j.equalsIgnoreCase(sOrg))
                FrameworkUtil.updateCustomResultBasedOnStatus(true, sOrg + " organization displayed after selction" );
...
Revision History:
     ...
     @Test(priority=1)	
      public static void verifyOrgDataBySelectingFromEBPanelMultiOrg()
      	 {
      	    ...
      	    PageFactory.initElements(driver,UPMultiOrg);
      	  	...
      	  	String sUserName=null,sPassword=null,sOrgtoSelect=null,sFLCOrgName=null;
      ...
      try {
  			    ...
  			    sFLCOrgName = (String)FrameworkUtil.dictPropertyData.get("NAV.USER.EBPANEL.FIRST.LEVEL.TST.ORGNAME");
  				...
  				AdminTestCase.verifyOrg(sFLCOrgName,sOrgtoSelect);
  				
  				//Logout from Navigator
  				LoginTestCase_Old1.nav_Signout();
  			    
  				//LoginTestCase.nav_Login(sUserName, sPassword);
  				//LoginTestCase.LoginAsTstMultiOrgRoleA1User();
  				LoginTestCase_Old1.LoginAsQaautoMMultiOrgUser();
  				//WebObjectUtil.explicitWait(3);
 ...
 /*==============================================================
	...
	public void navValEntityBrwsrMultiOrgData()
	{
		...
		FrameworkUtil.sTestCaseName = "navValEntityBrwsrMultiOrgData";
		...
		WebObjectUtil.explicitWait(15);
		//HomeTestCase.nav_WindStreamToTierPointHomePopup();
		sOrganizationName=UPMultiOrg.getNav_OrganizationnameLink().getText();
	...
	public void nav_VerifyFirewallCount(){
	    ...
	    FrameworkUtil.sTestCaseName="MultiOrg-nav_VerifyFirewallCount";
 ...
 public static void	checkEBNotUpdateTop()
 {
 	      ...
 	      // String sOrgtoSelect = (String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.ORG.NAME2");
 	       ...
 	       try {
 			  ...
 			  /* WebObjectUtil.selectWebList(UPMultiOrg.getNav_MOrg_SelectOrg(), sOrgtoSelect, null, 0);
 			   ...
 			   WebObjectUtil.explicitWait(2);
 			  HomeTestCase.nav_WindStreamToTierPointHomePopup();*/
 			   sUser = UPMultiOrg.getNav_OrganizationnameLink().getText();
  ...
  public static void checkOrgDataDropDown()
  {
  	    ...
  	    try {
  	    		...
  	    		sOrgName = UPMultiOrg.getNav_OrganizationnameLink().getText();
  				 if(!sOrg2toSelect.equalsIgnoreCase(sOrgName)){
  				//selectOrgnameInOrgSelector(sOrg2toSelect);
  					 selectOrgs(sOrg2toSelect);
  				 }
...
Pre-Requisites	:
 ...
 /*==============================================================
	...
	@Test(priority=201)
	public void navVerifyMultiOrgPermissionFunctionalityForEVDCVMEditFunctionality(){
		 String sMulOrgFireCount,sGirFireCount,sOrgName1=null,sEVDCName=null,sOrgName2=null;
		WebDriver driver = WebDriverUtil.getDriver();
	    ...
	    FrameworkUtil.sTestCaseName="navVerifyMultiOrgPermissionFunctionalityForEVDCVMEditFunctionality";
		...
		//the below lines updated by QAA03 on 05/23/2016 as functionality changed with respect to primary org "TST QAauto"
		if(!selectOrgs(sOrgName2))
		{
		selectOrgnameInOrgSelector(sOrgName2);
		}
		...
		boolean bRes=sEntityName.contains(sOrgName2);
		if(bRes)
		...
		WebElement wEntity=WebObjectUtil.GetWebElement("xpath", "//section[@id='user_management']//span[text()='"+sOrgName2+"']", "Entity");
		wEntity.click();
		...
		//The below lines updated by QAA03 on 05/13/2016
		...
		//if(wEdit==null) - updated on 01/07/2016 by QAA03
		if(wEdit!=null)
		{
		...
		WebObjectUtil.clickElement(UserPermission.getNav_PermissionsLink());
		WebObjectUtil.clickElement(UserPermission.getNav__ManageEntityTab());
		WebElement wEntity1=WebObjectUtil.GetWebElement("xpath", "//section[@id='user_management']//span[text()='"+sOrgName2+"']", "Entity");
		wEntity1.click();
		WebObjectUtil.clickElement(ManageEntity.getNav_EditEntityFirstRowImg());
...
//			String sPassword =(String)FrameworkUtil.dictPropertyData.get("NAV.USER.MULTORG.PASSWORD.AROLE");
			...
			WebObjectUtil.explicitWait(3);
			WebObjectUtil.clickElement(UPMultiOrg.getNav_OrganizationnameLink());
...
/*			String sUserName =(String)FrameworkUtil.dictPropertyData.get("NAV.MULTIORG.USERID");
			...
			LoginTestCase_Old1.LoginAsTestMultiOrgUser();
...
/////////********************************Vivek Start***********************************/////////////////
	...
	public static void valManageEntityMultiOrgCpyPermission()
	{
		...
		sAgentUserName=(String)FrameworkUtil.dictPropertyData.get("NAV.TSTGETSMART.USERID.AGENT99");
		sAgentPassword=(String)FrameworkUtil.dictPropertyData.get("NAV.TSTGETSMART.PWD.AGENT99");
		...
		WebObjectUtil.selectWebList(UPMultiOrg.getNav_MultiOrgDropDown(), "11 Giraffes", null, null);
		...
		selectOrgnameInOrgSelector(sMultiOrg);
		...
		//Commented by QAA03 on 05/13/2016
		/*//Clicking on Edit pencil link
		...
		try {
		  ...
		  //Login to Navigator with testmultiorg-RoleA1 user
		   ...
		   LoginTestCase_Old1.LoginAsQaautoMMultiOrgUser();
	        ...
	        TicketTestCase.verifyTicketCountAfterRollOn(sTstDevco,Ticket.getNav_Outstanding());
	        TicketTestCase.verifyTicketCountAfterRollOn(sTstDevco,Ticket.getNav_ClosedLess());
	    	
	        TicketTestCase.verifyTicketCountAfterRollOn(sTstDevco,Ticket.getNav_ClosedMore());
	...
	public void verifyRollOnOffforMultiOrgUsers()
	{
		...
		/*	sUserName = (String)FrameworkUtil.dictPropertyData.get("NAV.MULTIORG.USERID.QAAUTOM");
		   ...
		   //LoginTestCase.LoginAsTstMultiOrgRoleA1User();
	        ...
	        arrEVDCNameList = EVDC_Overview_TestCase.getEVDCNameforEntityAndItsChild(sTstDevco);
			...
			EVDC_Overview_TestCase.verifyEVDCnameForEntityAndItsChild(arrEVDCNameList);
	
		
			//verify parent - child EVDC name for 11Giraffe
			UserPermissionMultiOrgTestCase.selectOrgnameInOrgSelector(s11Giraffe);
			
			arrEVDCNameList = EVDC_Overview_TestCase.getEVDCNameforEntityAndItsChild(s11Giraffe);
	...
	public void verifyEVDCtableAfterRollOn()
	{
		...
		try {
	       ...
	       //HomeTestCase.nav_WindStreamToTierPointHomePopup();
	        ...
	        //Verify PDF reports
	        WebObjectUtil.verifyElementPresent(EVDC_OverviewPF.getNav_EVDCViewPDFIcon());
	        //Verify CSV reports
	        WebObjectUtil.verifyElementPresent(EVDC_OverviewPF.getNav_EVDCViewCSVIcon());
			...
			LoggerUtil.log_type_error("catch block:" + FrameworkUtil.sElementName);
			FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), FrameworkUtil.sElementName , "verifyEVDCtableAfterRollOn", "warn", "catch block:" +e.getMessage());
		}
   }
 ...
 /*public static void editEntity(String sEntityName)
 {
	...
	public static boolean selectOrgnameInOrgSelector(String sOrgName){
		...
		try {
			...
			sOrgNameRunTime = UPMultiOrg.getNav_OrganizationnameLink().getText();
			...
			wOrgName.click();
			WebObjectUtil.waitForPageLoad();
			FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), "selectOrgnameInOrgSelector", "Select Org from Org Selector" , "done", "Displayed Org name:" + sOrgNameRunTime + ", and Org name selected : " + sOrgName);
			}
			bFlag=true;
		...
		try {
			...
			if (sOrgNameRunTime.equalsIgnoreCase(sOrgName))  {
				bFlag=true;
				FrameworkUtil.writeCustomResult(FrameworkUtil.stepNo(), "selectOrgnameInOrgSelector", "Select Org from Org Selector" , "done", "Displayed(current) Org name:" + sOrgNameRunTime );
				return bFlag;
			}
			//WebObjectUtil.MouseHover(UPMultiOrg.getNav_MOrg_OrgName());
