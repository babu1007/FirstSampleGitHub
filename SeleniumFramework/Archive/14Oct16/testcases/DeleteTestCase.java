...
public class DeleteTestCase {
	...
	public void deleteOldVMTest(){
	 ...
	 {  
	  ...
	  //Added By Sukur Babu. Dated n 07/10/2016. As discussed with Arul.
	  String sCurrentUrl = driver.getCurrentUrl();
      String[] arrURL = sCurrentUrl.split(".com"); 
      String sSummaryURL=arrURL[0]+".com";
      String sCatalogURL = sSummaryURL +arrURL[1];
	 ...
	 ==============================================================*/
		...
		public static void deleteOldVMs(String sUserName,String sPassword){
			...
			try {
				...
				//Commented by Sukur Babu. Dated on 06/10/2016 as getNav_EVDCname() element belongs to EVDC_OverviewPF not Home
				//WebObjectUtil.clickAndVerifyElement(Home.getNav_EVDCname(), EVDC_OverviewPF.getNav_EVDCOverviewVirtualMachine());
...
public static void deleteFailedVM(WebElement wTableRowAsWebElement, int iRowNo){
	...
	try {
		...
		if (sRowText.contains("Delete")){
			...
			WebObjectUtil.explicitWait(10);
			FrameworkUtil.updateCustomResultBasedOnStatus(true, "Delete Failed VM : " +Common.getNav_UsrFeedBack().getText());
