...
/*==============================================================
Method Name 	: nav_LoginWithoutPopup
Description		: This method will login Navigator using   sUserName and sPassword
Author 			: Arul
Creation Date 	: 10/24/2014
Pre-Requisites	:
Revision History:Revised by Priyanka on 4/15/2016
==============================================================*/

public static boolean nav_LoginWithoutPopup(String sUserName,String sPassword)
{
	String sURL=null;
	WebDriver driver = WebDriverUtil.getDriver();
	PageFactory.initElements(driver, login);
...
/*==============================================================
MethodName 		: LoginAsEVDCQuaautoaUser
Manual TestCase	: 
...
==============================================================*/
public static Boolean LoginAsEVDCQaautoaUser() {
...
/*==============================================================
MethodName 		: LoginAsQuaautoEUser
Manual TestCase	: 
