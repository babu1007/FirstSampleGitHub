...
/*			if (!bstatus){
	...
	/*	FrameworkUtil.sTestCaseName = "verifyBuildInfo";
		...
		*/
		...
		WebObjectUtil.assertElementPresent(aboutPage.getNav_ReleaseNumber());
		WebObjectUtil.assertElementPresent(aboutPage.getNav_ReleaseNumberValue());
		WebObjectUtil.assertElementPresent(aboutPage.getNav_BuildNumberValue());
		WebObjectUtil.assertElementPresent(aboutPage.getNav_BuildDateValue());
