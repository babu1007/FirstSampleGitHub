...
@BeforeSuite	
@Parameters({"browser","browserVersion","OperatingSystemName","OperatingSystemVersion","runningPlatform","TestDatapropertyFileName","SeleniumWorkSpacePath","CustomResultLocation"})
public static void initWebDriver(String browser,String browserVersion,String os,String osVersion,String runLocation,String TestDatapropertyFileName, String SeleniumWorkSpacePath,String CustomResultLocation){
